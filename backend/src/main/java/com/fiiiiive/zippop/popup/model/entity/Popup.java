...
public class Popup extends BaseEntity {
    ...
    private List<PopupReview> popupReviewList = new ArrayList<>();
    ...
    @Builder.Default
    @OneToMany(mappedBy = "popup", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<PopupLike> popupLikeList = new ArrayList<>();
    ...
    // Update
    public Popup update(UpdatePopupReq req){
        this.name = req.getPopupName();
        this.content = req.getPopupContent();
        this.address = req.getPopupAddress();
        this.category = req.getCategory();
        this.totalPeople = req.getTotalPeople();
        this.startDate = req.getPopupStartDate();
        this.endDate = req.getPopupEndDate();
        return this;
    }
    ...
    public static Page<GetPopupRes> toDtoPage(Page<Popup> popupPage) {
