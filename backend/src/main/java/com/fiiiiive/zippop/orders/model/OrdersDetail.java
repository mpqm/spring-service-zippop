...
public class OrdersDetail extends BaseEntity {
    ...
    public OrdersDto.GetOrdersDetailRes toDto() {
        return OrdersDto.GetOrdersDetailRes.builder()
    ...
    public static List<OrdersDto.GetOrdersDetailRes> toDtoList(List<OrdersDetail> ordersDetailList) {
