package com.fiiiiive.zippop.domain.auth.controller;

import com.fiiiiive.zippop.domain.auth.dto.AuthDto;
import com.fiiiiive.zippop.domain.auth.service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<BaseResponse<Void>> findId(
        @Valid @RequestBody AuthDto.FindUserIdReq dto) throws BaseException {
    ...
    public ResponseEntity<BaseResponse<Void>> findPassword(
        @Valid @RequestBody AuthDto.FindPasswordReq dto) throws BaseException {
