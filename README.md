...
<details>
    ...
    <ul>
        <li>
            ...
            <div align="left">
                <img src="meta/image/기사1.png" width=500, height=310><br>
        ...
        <li>
            ...
            <div align="left">
                <img src="meta/image/기사2.png" width=500, height=300><br>
        ...
        <li>
            <p>팝업 스토어 흥행요인 </p><br>
            <div align="left">
                <img src="meta/image/기사3.png" width=500, height=300><br>
                <a>https://www.donga.com/news/Economy/article/all/20231201/122446644/1</a>
            </div>
        </li>
    </ul>
...
<details>
    ...
    <ul>
        <li> 전 프로젝트(V1)는 끝났지만 미구현 기능 및 프론트엔드 미완성</li>
        <br>
        <li> 부실한 문서들을 개발문서들을 통합관리하고, GithubAction CICD 추가 시작</li>
        <br>
        <li> 주요 기능 리프레쉬 토큰 및 대기열을 추가한 프로젝트 v2를 개인으로 시작</li>
        <br>
        <li> 그 외 기능은 v1문서 참조</li>
        <br>
    </ul>
</details>
...
| **프로젝트 개발 산출물**       | **링크**                                                                                                                                                                           |
|-----------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 🎡 ERD & Architecture | [ERD & Architecture](meta/doc/ERD%20%26%20아키텍처.md)                                                                                                                                        |
| ➰ 요구사항 정의서            | [요구사항 정의서](meta/doc/요구사항정의서.md)                                                                                                                                               |
| 📃 백엔드 API 명세서        | [백엔드 API 명세서](meta/doc/백엔드%20API%20명세서.md)                                                                                                                                    |
...
| 🔎 기능 설명 및 성능 개선      | [기능 설명 및 성능 개선](meta/doc/기능%20설명%20및%20개선.md)                                                                                                                                 
